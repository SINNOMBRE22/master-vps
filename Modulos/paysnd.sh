...
# ════════════════════════════════════════════════════════════════════
# VPS MÁSTER - Generador de Payloads
# Creado por: SINNOMBRE22
# Fecha: 2025-10-18 03:10:43 UTC
...
err_fun () {
echo -e "${cor[5]} Operación inválida"
exit
}
echo -e "${cor[1]}$bar${cor[0]}"
echo -e "                    ⇱ Generador de Payloads ⇲"
echo -e "${cor[1]}$bar${cor[3]}"
gerar_pay () {
read -p " Host Objetivo: " valor1
[[ -z "$valor1" ]] && err_fun
valor2="127.0.0.1"
echo -e "${cor[1]}$bar${cor[0]}"
echo -e "                  ⇱ Método de Solicitud ⇲"
echo -e "${cor[3]}"
...
echo -e "${cor[1]}$bar${cor[0]}"
read -p " Ingrese el Proxy: " hostprox
read -p " Ingrese el Puerto: " portx
echo -e "${cor[1]}$bar${cor[0]}"
echo -e "                        ⇱ INICIANDO ⇲"
echo -e "${cor[1]}$bar${cor[0]}"
}
...
echo -e "${cor[1]}$bar${cor[3]}"
echo -e " [1]-Probar Un Payload"
echo -e " [2]-Probar Payloads Registrados"
echo -e "${cor[1]}$bar${cor[0]}"
read -p " [1-2]: " opx
case $opx in
1)
read -p " Ingrese el Payload: " payloadx
read -p " Ingrese el Proxy: " hostprox
read -p " Ingrese el Puerto: " portx
echo -e "${cor[1]}$bar${cor[0]}"
...
echo -ne "\033[1;31mRespuesta:\033[1;32m\n"
